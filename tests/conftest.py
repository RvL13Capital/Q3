    ...
    return {
        ...
        "signals": {
            ...
            "crowding": {
                ...
                "cost_to_borrow_high":  0.10,
                "utilization_high":     0.80,
                "csd_omega_gamma":      0.10,
                "gamma_lookback_days":  5,
                "gamma_threshold_low":  -0.5,
                "gamma_threshold_high": 0.5,
                "csd_omega_iv_skew":    0.10,
                "skew_threshold_low":   1.0,
                "skew_threshold_high":  1.4,
                "csd_omega_put_call":   0.10,
                "pc_threshold_low":     0.5,
                "pc_threshold_high":    1.5,
                "min_components_full_confidence": 4,
                "coverage_penalty_floor": 0.40,
            },
            "quality": {
